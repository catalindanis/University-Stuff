...
public:
	...
	*/
	...
	/*
	Constructorul unui obiect de tip carte
	@param id : id-ul cartii (long)
	@param title : titlul cartii (string)
	@param author : autorul cartii (string)
	@param type : tipul cartii (string)
	@param releaseYear : anul aparitiei cartii (int)
	*/
	Book(const int& id, const string title, const string author, const string type, const int releaseYear);
	...
	*/
	...
	/*
	Functia seteaza id-ul unei carti
	@param newId : id-ul cartii (long)
	*/
