...
private:
	...
	*/
	...
	Validator& validator;
	vector<UndoAction*> undoOperations;
public:

	/*
	Constructorul service-ului de carti
	*/
	Service(AbstractRepository& repository, Validator& validator);
	...
	@throws : BookRepositoryException, daca
			cartea exista deja
	@throws : BookCreationException, daca
	...
	*/
	...
	/*
	Functia returneaza o carte dupa index-ul ei
	@return cartea (Book)
	@throws : BookRepositoryException("Cartea nu exista!");
	*/
	const Book& getBookByIndex(const int& index) const;
	...
	*/
	...
	/*
	Functia adauga un set de date deja prestabilite in repository-ul de carti
	*/
	...
	*/
	...
	de carti
	@throws exception : daca nu se mai poate face undo
	*/
	void undoLastOperation();

	/*
	Functia genereaza un id pentru o carte
	@return id-ul generat (long)
	*/
	long generateId();
};
