...
//		if (readDayFromUser(&day) == false)
//			return;
//		getExpensesFromServiceFilteredByDay(day, result, &resultLength, service);	
//		break;
//	case 2:
//		if (readSumFromUser(&sum) == false)
//			return;
//		getExpensesFromServiceFilteredBySum(sum, result, &resultLength, service);
//		break;
//	case 3:
//		if (readTypeFromUser(&type) == false)
//			return;
//		getExpensesFromServiceFilteredByType(type, result, &resultLength, service);
//		break;
//	default:
//		if (filterType == -1)
//			printf("Valoarea introdusa nu este numar natural!\n");
...
//			printf("Cheltuiala #%d: ", i);
//			//printExpenseStringFormat(&result[i]);
//			printf("\n");
//		}
//	}
...
//			case 1:
//			case 2:
//				getExpensesFromServiceSortedBySum(sortType == 1, result, service);
//				break;
//			default:
//				if (sortType == -1)
//					printf("Valoarea introdusa nu este numar natural!\n");
...
//			case 1:
//			case 2:
//				getExpensesFromServiceSortedByType(sortType == 1, result, service);
//				break;
//			default:
//				if (sortType == -1)
//					printf("Valoarea introdusa nu este numar natural!\n");
...
//
//	if (result) {
//		int length = getNumberOfExpenses(service);
//		for (int i = 0; i < length; i++) {
//			printf("Cheltuiala #%d: ", i);
//			//printExpenseStringFormat(&result[i]);
//			printf("\n");
