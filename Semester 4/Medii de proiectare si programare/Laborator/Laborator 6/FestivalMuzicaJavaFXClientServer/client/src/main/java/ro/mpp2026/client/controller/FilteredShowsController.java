...
public class FilteredShowsController implements PropsReceiver, Observer {
    ...
    private final Service showsService;

    public FilteredShowsController(Service showsService) {
    ...
    private void loadData() {
        ...
        ObservableList<Show> shows = FXCollections.observableArrayList(showsService.findAll(showFilter));
