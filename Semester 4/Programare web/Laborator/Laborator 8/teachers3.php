...
<head>
    ...
    <title>Meditații pentru toți - Profesori 3</title>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
    <script src="teachers3.js"></script>
</head>
...
<body>
    ...
    <div class="container content">
        <div class="title-container">
            <span class="title">Profesori - Cerința 3</span>
        </div>

        <div id="section">
            <h2>Listă de profesori cu paginare (jQuery AJAX)</h2>
            ...
            <div id="page-info" class="pagination-info">Se încarcă datele...</div>
        </div>
    </div>
