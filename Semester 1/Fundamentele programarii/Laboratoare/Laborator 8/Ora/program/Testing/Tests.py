...
def testMovieService():
    ...
    assert service.generateRandomMovies(5) == True
    assert len(service.getAllMovies()) == 5
    assert service.generateRandomMovies(2) == True
    assert len(service.getAllMovies()) == 7
