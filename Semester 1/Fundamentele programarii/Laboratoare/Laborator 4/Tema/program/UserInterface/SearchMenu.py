...
from program.Utils.Generals import *
...
4.Inapoi"""
    ...
    def __searchExpensesGreaterThanSum(expenses):
        ...
        result = searchExpensesGreaterThanSum(sum, expenses)
    ...
    def __searchExpensesBeforeDayAndLessThanSum(expenses):
        ...
        result = searchExpensesBeforeDayAndLessThanSum(day, sum, expenses)
    ...
    def __searchExpensesOfType(expenses):
        ...
        result = searchExpensesOfType(type, expenses)
