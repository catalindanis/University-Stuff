...
def testRentService():
    ...
    assert service.getTopMovieTypesByNumberOfRents() == {1 : 2, 2 : 2, 3 : 1, 4 : 1}

    service.unrentMovie(2, 4)

    assert service.getTopMovieTypesByNumberOfRents() == {1: 2, 2: 1, 3: 1, 4: 1}

    service.rentMovie(2, 4)
    service.rentMovie(2, 3)

    assert service.getTopMovieTypesByNumberOfRents() == {2: 3, 1: 2, 3: 1, 4: 1}
    #assert False
