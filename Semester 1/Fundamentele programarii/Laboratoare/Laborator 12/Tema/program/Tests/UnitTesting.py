...
class TestClientService(unittest.TestCase):
    ...
    def test_get_client_by_id(self):
        ...
        """
        self.service.addClient("John Doe", "123")
        client = self.service.getClientByIdRecursive(len(self.service.getAllClients()),self.service.getAllClients(),0)
    ...
    def test_get_client_by_invalid_id(self):
        ...
        :return:
        """
        client = self.service.getClientByIdRecursive(len(self.service.getAllClients()),self.service.getAllClients(),99)
...
class TestSorting(unittest.TestCase):
    """
    Clasa de test pentru sortarile definite in fisierul Sorting
    """
    def test_bubble_sort(self):
        array = [1, 3, 5, 1, 2, 4]
        array = bubbleSort(array, None, False)
        self.assertEqual(array, [1, 1, 2, 3, 4, 5])
        array = bubbleSort(array, None, True)
        self.assertEqual(array, [5, 4, 3, 2, 1, 1])

    def test_shell_sort(self):
        array = [1, 3, 5, 1, 2, 4]
        array = shellSort(array, None, False)
        self.assertEqual(array, [1, 1, 2, 3, 4, 5])
        array = shellSort(array, None, True)
        self.assertEqual(array, [5, 4, 3, 2, 1, 1])
