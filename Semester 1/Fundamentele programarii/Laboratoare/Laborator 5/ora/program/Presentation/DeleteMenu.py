from Business.Service import deleteExpensesOfType, deleteExpensesFromDay, deleteExpensesFromInterval
...
4.Inapoi"""
    ...
    def __deleteExpensesFromDay(expenses):
        ...
        counter = deleteExpensesFromDay(expenses, day)
    ...
    def __deleteExpensesFromInterval(expenses):
        ...
        counter = deleteExpensesFromInterval(expenses, day1, day2)
    ...
    def __deleteExpensesOfType(expenses):
        ...
        counter = deleteExpensesOfType(expenses, type)
