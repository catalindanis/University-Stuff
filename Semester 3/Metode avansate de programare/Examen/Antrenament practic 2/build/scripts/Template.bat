...
set DEFAULT_JVM_OPTS="--module-path" "%APP_HOME%\lib" "--module" "org.example.template/org.example.template.Application"
...
"%JAVA_EXE%" %JAVA_OPTS% %TEMPLATE_OPTS% %DEFAULT_JVM_OPTS% %*
