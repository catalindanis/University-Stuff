...
public class Person extends User implements Serializable {
    ...
    public Person(long id, String username, String email, String password, String firstName, String lastName, LocalDate dateOfBirth, String occupation, int empathyLevel, UserType userType) {
        super(id, username, email, password);
        this.firstName = firstName;
        this.lastName = lastName;
        this.dateOfBirth = dateOfBirth;
